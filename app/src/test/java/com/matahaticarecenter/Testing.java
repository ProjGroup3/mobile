...
public class Testing extends ViewTest {
    ...
    private void startActivity() throws NullPointerException, ClassCastException {
        /****** initiation of Test ******/
        //Robolectric Pack
        testingActivity = Robolectric.buildActivity(TestingActivity.class).create().get();

        //Load layout
        int compId = testingActivity.getResources().getIdentifier(layoutName, "id", testingActivity.getPackageName());
        layout = testingActivity.findViewById(compId);
    }
